...
namespace amanaWebAPI.Repositories
{
    public class TaxaRepository : ITaxaRepository
    {
        ...
        public List<Taxa> BuscarDados(int idPlantio)
        {
            ...
            }).Where(t => t.IdPlantio == idPlantio).ToList();
        ...
        public List<Taxa> BuscarDados(TaxaViewModel taxa)
        {
            List<Taxa> taxas = ctx.Taxas
                ...
                .Where(t => t.IdPlantio == taxa.IdPlantio && t.IdNivelCobertura == taxa.IdNivelCobertura)
                .ToList();
